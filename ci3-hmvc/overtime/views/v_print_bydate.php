...
<body>
  ...
  <table>
    ...
    <tr>
      ...
      <td>:</td>
      <td style="text-align: left"><strong><?=date("d-M-Y", strtotime($fromDate)); ?></strong></td>
    </tr>
    <tr>
      <td style="text-align: left">Until date </td>
      <td>:</td>
      <td style="text-align: left"><strong><?=date("d-M-Y", strtotime($untilDate)); ?></strong></td>
    </tr>
  </table>
